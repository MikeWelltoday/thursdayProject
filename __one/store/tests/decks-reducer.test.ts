import {createDecksItem, decksReducer, DecksStateType, setDecksAC} from '../reducers/decks-reducer.ts'
...
test('', ()=> {
    ...
    const createdDeckFromServer = {
        author: {id: '920b29a5-af12-4d84-b7c0-e2b6dd114bac', name: 'MK'},
        cardsCount: 1,
        cover: null,
        created: '2024-03-22T09:21:02.235Z',
        id: 'clu2gbkm2029pvq2gazfmi4vk',
    ...
    const endState = decksReducer(startState, createDecksItem(createdDeckFromServer))

    expect(endState.decks.length).toBe(1)
    expect(endState.decks[0]).toEqual(createdDeckFromServer)
})
